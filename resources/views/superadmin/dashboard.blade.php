                    ...
                    <li class="mb-1">
                      ...
                      <div class="collapse" id="stockings-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          <li><a href="{{route('userform')}}" class="link-light rounded">Add User</a></li>
                          <li><a href="{{route('showuser')}}" class="link-light rounded">Show User</a></li>
                        </ul>
                      </div>
                    </li>
                  </ul>
