...
<div class="album py-3 product-page-bg">
    ...
    {{-- Page Heading Text --}}
    <h1 style="padding-left: 2rem; font-size: xx-large; font-family: Viga; color: black;">Notebook</h1>
</div>
        ...
        <div id="catalogCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active catalog-carousel">
              <img src="{{asset('frontend/image/notebook-carousel-1.jpg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item catalog-carousel">
              <img src="{{asset('frontend/image/notebook-carousel-2.jpg')}}" class="d-block w-100" alt="...">
            </div>
          </div>
