                        ...
                        <div class="col-4">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="card=text harga-promo" style="font-weight: bold; font-size: x-large;">Rp {{number_format($produks->harga)}}</p>
                                  <div class="d-flex align-items-center">
                                    <div>
                                      ...
                                      <form action="{{route('cartdetail.store')}}" method="POST">
                                        ...
                                        <button class="btn btn-md btn-dark mt-2" type="submit">
                                            <a>Tambah ke</a>
